            ...
            <ul class="list-unstyled components">
                ...
                <li class="">
                    <a href="{{ route('dashboard.products.index') }}"><i
                            class="material-icons">date_range</i><span>products</span></a>
                </li>

                <li class="">
                    <a href="{{ route('suppliers.index') }}"><i
                            class="material-icons">library_books</i><span>Suppliers</span></a>
                </li>
                <li class="">
                    <a href="{{ route('admin.orders.index') }}"><i
                            class="material-icons">library_books</i><span>Order</span></a>
                </li>
