                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="post"
                                                action="{{ route('admin.orders.complete', $order->order_id, $order->order_id) }}">
                                                @csrf
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Huỷ</button>
                                            <form method="post"
                                                action="{{ route('admin.orders.deliver', $order->order_id, $order->order_id) }}">
                                                @csrf
                                                @method('PUT')
                                                <button type="submit" class="btn btn-primary">Xác nhận</button>
                                            </form>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Huỷ</button>
                                            <form method="post"
                                                action="{{ route('customer.orders.destroy', $order->order_id) }}">
                                                @csrf
                                                @method('PUT')
                                                <button type="submit" class="btn btn-primary">Xác nhận</button>
                                            </form>
