                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a href="{{route("suppliers.show", $supplier->id)}}" class="btn btn-sm btn-outline-secondary">Chi tiết</a>
                                <a href="{{route("suppliers.edit", $supplier->id)}}" class="btn btn-sm btn-outline-secondary">Sửa</a>
                            </div>
                        </div>
                    </div>
                </div>
